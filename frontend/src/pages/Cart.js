import React, { useContext, useEffect } from 'react'; // useState removed since it's not used
      ...
      <div className="bg-white shadow">
        <div className="px-4 py-6 sm:px-8 sm:py-10">
              ...
              <li key={item._id} className="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                ...
                <div className="relative flex flex-1 flex-col justify-between">
                  ...
                  <div className="absolute top-0 right-0 flex sm:bottom-0 sm:top-auto">
                    <button onClick={() => handleRemoveFromCart(item._id)} type="button" className="flex rounded p-2 text-center text-gray-500 transition-all duration-200 ease-in-out focus:shadow hover:text-gray-900">
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <p className="text-2xl font-semibold text-gray-900">${calculateSubtotal().toFixed(2)}</p>
          </div>
